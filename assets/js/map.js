...
//Geocoding API
  ...
  fetch(geoUrl)
    ...
    // function initMap() {
    //   var myMapCenter = {lat: latGeo, lng: lngGeo};
    ...
    //   {
    //     name: 'Gameing Goat',
    //     location: {lat:42.35966750965475, lng: -87.94286053696173},
    //     hours: '8AM to 10PM'
    //   },
    //   {
    //     name: 'Gift of Games',
    //     location: {lat:42.34674332238447,  lng: -88.04305250981282},
    //     hours: '9AM to 9PM'
    //   }
    // ];
    ...
    // }
    // initMap();
// var mapUrl = 'https://maps.googleapis.com/maps/api/place/textsearch/json?query=magic:+the+gathering&location=41.8925085,-87.61616959999999&radius=10000&region=us&type=store&key=AIzaSyBQAOk0W2SlKiP_6sSlIBYz_H8XHL-1-DM';
...
searchFormEl.addEventListener('click', handleSearchFormSubmit);
        ...
        //Places API
        // var mapUrl = 'https://maps.googleapis.com/maps/api/place/textsearch/json?query=magic:+the+gathering&location=60.1291989,-176.4691749&radius=10000&region=us&type=store&key=AIzaSyBQAOk0W2SlKiP_6sSlIBYz_H8XHL-1-DM';
